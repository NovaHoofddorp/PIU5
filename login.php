...
if (isset($_POST['login_btn'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        $_SESSION['message'] = "U bent nu ingelogt";
        $_SESSION['username'] = $username;
        header("location: home.php"); //redirect to home page
    }else{
        $_SESSION['message'] = "Gebruikersnaam/wachtwoord combinatie is incorrect";
    }
}
?>
<!DOCTYPE html>
...
<div class="topnav" id="myTopnav">
    ...
    <div id="navLinkMenuBoven"><a href="login.php">Aanmelden</a></div>
    <div id="navLinkMenuOnder"><a href="register.php">Registreren</a></div>
    <div class="navLinkRechts"><a href="login.php">Aanmelden</a></div>
    <div class="navLinkLinks"><a href="register.php">Registreren</a></div>
...
<div class="content">
    ...
    <div class="loginboxinside">
        ...
        if (isset($_SESSION['message'])) {
            echo "<div id='error_msg' style=\"color:red;\">".$_SESSION['message']."</div>";
        ...
        <form method="post" action="login.php">
            <table>
                <tr>
                    <td>Username:</td>
                    <td><input type="text" name="username" class="textInput" autofocus></td>
                </tr>
